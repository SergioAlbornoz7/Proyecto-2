...
public interface Variables {
	...
	public final float UPGRADE_PLUS_DEFENSE_TECHNOLOGY_IRON_COST = (float) 0.2;
	public final float UPGRADE_PLUS_ATTACK_TECHNOLOGY_IRON_COST = (float) 0.2;
	...
	public final float UPGRADE_PLUS_DEFENSE_TECHNOLOGY_WOOD_COST = (float) 0.15;
	public final float UPGRADE_PLUS_ATTACK_TECHNOLOGY_WOOD_COST = (float) 0.15;
	...
	public final float UPGRADE_PLUS_DEFENSE_TECHNOLOGY_FOOD_COST = (float) 0.10;
	public final float UPGRADE_PLUS_ATTACK_TECHNOLOGY_FOOD_COST = (float) 0.10;
